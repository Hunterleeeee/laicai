...
extension AppStore {
    ...
    private func applySkillPromptHint(_ match: SkillMatchResult, connector: ConnectorProfile, loopConfig: inout AgentLoop.Config) {
...
"""
    ...
    private func appendPendingFollowUp(to targetTaskID: UUID) {
